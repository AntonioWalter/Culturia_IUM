...
\rowcolor{culturiaBeige}
  & Giovanni {\footnotesize(Impiegato)}      & \textbf{N} & Alta  & Alta  & Utilizza l'app come supporto visivo per indicare percorsi e uscite d'emergenza ai turisti. \\
...
\textbf{2.\ Comprensione a fondo e adattamento del livello di dettaglio}
  ...
  & Giovanni {\footnotesize(Impiegato)}      & \textbf{N} & Media & Alta  & Verifica l'accuratezza e l'autenticità dei contenuti digitali esposti. \\
...
\rowcolor{culturiaBeige}
  & Giovanni {\footnotesize(Impiegato)}      & \textbf{F} & Bassa & Bassa & Pur non partecipando, suggerisce queste attività per intrattenere i visitatori. \\

\midrule

% ── TASK 4 ─────────────────────────────────────────────────────
\textbf{4.\ Gestione e authoring dei contenuti culturali} \newline {\footnotesize(Pubblicazione autonoma dei contenuti)}
  ...
  & Giovanni {\footnotesize(Impiegato)}      & \textbf{N} & Alta  & Alta  & Task costitutivo del suo ruolo gestionale: senza di lui i contenuti non esistono sull'app. \\
...
\textbf{1.1 Scansione RFID} \newline {\footnotesize(Avvio contestuale)}
  ...
  & Giovanni & \textbf{N} & Alta & Alta & Attivazione rapida dei tour per supportare i visitatori. \\

\midrule

\rowcolor{culturiaBeige}
\textbf{1.2 Filtraggio accessibile profilato} 
...
\rowcolor{culturiaBeige}
  & Giovanni & \textbf{N} & Alta & Alta & Guida sicura ed inclusiva per disabili e famiglie. \\
...
\textbf{1.3 Sincronizzazione tour in simultanea}
  ...
  & Giovanni & \textbf{F} & Bassa & Media & Suggerito per fluidificare il traffico di gruppi nelle sale. \\
...
\rowcolor{culturiaBeige}
  & Giovanni & \textbf{N} & Media & Alta & Ispezione per validare la corrispondenza con la realtà fisica. \\
...
\textbf{2.2 Selezione "Tone of Voice" (IA)}
  ...
  & Giovanni & \textbf{N} & Media & Alta & Monitoraggio della qualità informativa erogata. \\
...
\rowcolor{culturiaBeige}
  & Giovanni & \textbf{F} & Bassa & Bassa & Funzionalità non pertinente al ruolo di sorveglianza. \\

\bottomrule
\end{tabular}%
}
\caption{Analisi dei Sotto-task: Comprensione a fondo e adattamento del dettaglio.}
...
\textbf{3.1 Dashboard e Progressioni}
  ...
  & Giovanni & \textbf{F} & Bassa & Bassa & Non pertinente alla propria attività lavorativa. \\
...
\rowcolor{culturiaBeige}
  & Giovanni & \textbf{F} & Bassa & Bassa & Nessuna utilità professionale specifica. \\
...
\textbf{3.3 Liste di Missioni contestuali}
  ...
  & Giovanni & \textbf{F} & Alta & Bassa & Suggerisce le missioni ai turisti per orientarli nelle sale. \\
...
\textbf{4.3 Pubblicazione e versionamento}
  & Giovanni & \textbf{N} & Media & Alta  & Pubblicare aggiornamenti in produzione con possibilità di rollback in caso di errori. \\\hline

\rowcolor{culturiaBeige}
\textbf{4.4 Monitoraggio statistiche di visita}
  & Giovanni & \textbf{F} & Bassa & Media & Consultare analytics per ottimizzare l'offerta in base alla fruizione reale dei percorsi. \\
