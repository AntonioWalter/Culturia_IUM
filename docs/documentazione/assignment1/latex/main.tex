...
\begin{itemize}
    \item \textbf{Realtà Aumentata:} l'utente, giunto presso un sito culturale, potrà inquadrare con lo smartphone monumenti, facciate storiche o opere d'arte e ricevere in sovraimpressione contenuti digitali contestuali — ricostruzioni dell'aspetto originario di un edificio, narrazioni animate, informazioni stratificate per epoca — oppure seguire percorsi guidati AR lungo itinerari tematici.

    \item \textbf{Intelligenza Artificiale:} un assistente conversazionale accompagnerà l'utente durante l'esperienza, rispondendo a domande in linguaggio naturale, generando approfondimenti calibrati sul profilo culturale del visitatore e suggerendo percorsi ottimali in base a posizione, tempo disponibile e preferenze pregresse.
\end{itemize}
...
Questa visione è coerente con i principi della Convenzione di Faro, che pone al centro il diritto di ogni cittadino a partecipare attivamente alla vita culturale della propria comunità. Culturia, attraverso AR e IA, traduce quel principio in uno strumento concreto di \textit{empowerment}: non si limita a mostrare il patrimonio, ma abilita l'utente a viverlo, interpretarlo e condividerlo.
