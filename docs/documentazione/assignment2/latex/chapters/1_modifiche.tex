...
L'obiettivo principale di questo aggiornamento è riuscire a cogliere e misurare la reale capacità dell'utilizzatore medio di eseguire operazioni complesse da amministratore. In questo modo, intendiamo verificare se la nostra applicazione è in grado di conferire, anche a un impiegato privo di specifiche competenze informatiche, i "super-poteri" necessari per modellare percorsi, gestire informazioni digitali tridimensionali e intervenire per correggere tempestivamente inesattezze sui contenuti in esposizione.
